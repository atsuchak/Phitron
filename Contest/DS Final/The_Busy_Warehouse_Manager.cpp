...
// Problem link: https://www.hackerrank.com/contests/early-problem-solvers-club-selection-contest-batch-08-a-2k26/challenges/print-max-2
...
void solve() {
    ...
    while (n--) {
        ...
        if (k == 1) {
            ...
            if (cnt[x] > 0) a.erase(make_pair(cnt[x], x));
            cnt[x]++;
            a.insert(make_pair(cnt[x], x));
        } else if (k == 2) {
