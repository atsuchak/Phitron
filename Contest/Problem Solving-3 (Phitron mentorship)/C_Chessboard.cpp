...
//Problem link: https://vjudge.net/contest/781854#problem/C
...
void solve() {
    ...
    if(c == 0) cout << 'a' << r << endl;
    else if(c == 1) cout << 'b' << r << endl;
    else if(c == 2) cout << 'c' << r << endl;
    else if(c == 3) cout << 'd' << r << endl;
    else if(c == 4) cout << 'e' << r << endl;
    else if(c == 5) cout << 'f' << r << endl;
    else if(c == 6) cout << 'g' << r << endl;
    else if(c == 7) cout << 'h' << r << endl;
}
