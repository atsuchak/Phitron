//Problem link: https://www.hackerrank.com/contests/assignment-02-a-introduction-to-algorithms-a-batch-08/challenges/water-4-1
...
void solve() {
    ...
    sort(rall(vec));
    cout << min(vec[0].second, vec[1].second) << " " << max(vec[0].second, vec[1].second) << nl;
}
