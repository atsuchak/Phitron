//Problem link: https://www.hackerrank.com/contests/final-exam-a-introduction-to-algorithms-a-batch-08/challenges/tetranacci-number-a-easy-version
...
int func(int n) {
    ...
    dp[n] = func(n-1) + func(n-2) + func(n-3) + func(n-4);
    return dp[n];
}
